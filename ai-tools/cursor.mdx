...
<Card title="Getting started guide" icon="rocket" href="/quickstart/quickstart">
Complete walkthrough from installation to your first API call in under 10 minutes.
</Card>

<CardGroup cols={2}>
<Card title="Authentication" icon="key" href="/essentials/mono/authentication">
  Learn how to authenticate requests using API keys or JWT tokens.
</Card>

<Card title="Rate limiting" icon="clock" href="https://mintlify.com/docs/writing-content/updates">
